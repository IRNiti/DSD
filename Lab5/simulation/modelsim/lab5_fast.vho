...
-- SR_SEL	=>  Location: PIN_A14,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
-- P_SEL	=>  Location: PIN_F12,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
-- GR_SEL	=>  Location: PIN_G12,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
-- GR_LD	=>  Location: PIN_B14,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
-- SR_LD	=>  Location: PIN_E14,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
-- TM_IN	=>  Location: PIN_F13,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
-- TM_EN	=>  Location: PIN_H12,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
-- TC_EN	=>  Location: PIN_C13,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
-- TC_RST	=>  Location: PIN_A15,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
-- SOLVED	=>  Location: PIN_B15,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
-- CLK	=>  Location: PIN_M1,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: Default
-- START	=>  Location: PIN_M2,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: Default
-- TC_LAST	=>  Location: PIN_B16,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: Default
-- READY	=>  Location: PIN_A16,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: Default
-- SC_CMP	=>  Location: PIN_D14,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: Default
...
-- Equation(s):
-- \Selector10~0_combout\ = (\TC_LAST~combout\ & \y_present.G~regout\)
...
-- Equation(s):
-- \Selector9~0_combout\ = (!\TC_LAST~combout\ & (\y_present.G~regout\ & !\SC_CMP~combout\))
...
-- Equation(s):
-- \Selector8~0_combout\ = (!\TC_LAST~combout\ & (\y_present.G~regout\ & \SC_CMP~combout\))
...
-- Equation(s):
-- \Selector13~0_combout\ = (!\y_present.I~regout\ & !\y_present.H~regout\)
...
-- Equation(s):
-- \Selector17~0_combout\ = (\y_present.D~regout\) # ((\y_present.J~regout\) # ((!\y_present.G~regout\ & \GR_LD~reg0_regout\)))
...
-- Equation(s):
-- \Selector16~0_combout\ = (\y_present.G~regout\) # ((!\y_present.D~regout\ & (\P_SEL~reg0_regout\ & !\y_present.J~regout\)))
...
-- Equation(s):
-- \Selector1~1_combout\ = (\y_present.A~regout\) # ((\y_present.E~regout\) # (\y_present.D~regout\))
...
-- Equation(s):
-- \Selector1~0_combout\ = (\y_present.F~regout\) # ((\y_present.J~regout\) # ((\y_present.B~regout\) # (\y_present.G~regout\)))
...
-- Equation(s):
-- \Selector2~1_combout\ = (!\y_present.H~regout\ & (!\y_present.I~regout\ & ((!\y_present.C~regout\) # (!\TC_LAST~combout\))))
...
-- Equation(s):
-- \Selector1~2_combout\ = (\START~combout\) # ((\Selector1~1_combout\) # ((\Selector1~0_combout\) # (!\Selector2~1_combout\)))
...
-- Equation(s):
-- \Selector2~3_combout\ = (\Selector2~1_combout\ & (\START~combout\ & (\Selector2~0_combout\ & \Selector2~2_combout\)))
...
-- Equation(s):
-- \Selector3~0_combout\ = (\y_present.B~regout\) # ((!\TC_LAST~combout\ & \y_present.C~regout\))
...
-- Equation(s):
-- \Selector4~2_combout\ = (\y_present.D~regout\ & (((!\READY~combout\)))) # (!\y_present.D~regout\ & (\TC_LAST~combout\ & ((\y_present.C~regout\))))
...
-- Equation(s):
-- \Selector4~3_combout\ = (!\y_present.J~regout\ & (!\y_present.G~regout\ & (!\y_present.E~regout\ & \Selector4~2_combout\)))
...
-- Equation(s):
-- \Selector15~0_combout\ = (\y_present.D~regout\) # ((\GR_SEL~reg0_regout\ & !\y_present.J~regout\))
...
-- Equation(s):
-- \Selector14~0_combout\ = (\y_present.C~regout\) # ((\y_present.H~regout\) # ((!\y_present.I~regout\ & \TM_IN~reg0_regout\)))
...
-- Equation(s):
-- \Selector13~1_combout\ = (\y_present.C~regout\) # (((!\y_present.G~regout\ & \TM_EN~reg0_regout\)) # (!\Selector13~0_combout\))
...
-- Equation(s):
-- \Selector11~0_combout\ = (\TC_RST~reg0_regout\ & ((\y_present.H~regout\) # ((\y_present.E~regout\) # (\y_present.I~regout\))))
...
-- Equation(s):
-- \Selector11~2_combout\ = (\y_present.D~regout\) # ((\Selector11~0_combout\) # ((\y_present.J~regout\) # (\Selector11~1_combout\)))
...
-- Equation(s):
-- \Selector0~0_combout\ = (\y_present.F~regout\) # ((\y_present.A~regout\ & \SOLVED~reg0_regout\))
