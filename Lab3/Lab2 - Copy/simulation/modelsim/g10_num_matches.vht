...
-- ***************************************************************************
-- Generated on "10/16/2015 16:45:44"
                                                            
-- Vhdl Test Bench template for design  :  g10_num_matches
-- 
...
ENTITY g10_num_matches_vhd_tst IS
END g10_num_matches_vhd_tst;
ARCHITECTURE g10_num_matches_arch OF g10_num_matches_vhd_tst IS
-- constants                                                 
-- signals                                                   
...
SIGNAL N_exact : STD_LOGIC_VECTOR(2 DOWNTO 0);
