...
ARCHITECTURE structure OF g10_comp6 IS
...
-- Equation(s):
-- \inst9~0_combout\ = (\A~combout\(0) & (\B~combout\(0) & (\B~combout\(1) $ (!\A~combout\(1))))) # (!\A~combout\(0) & (!\B~combout\(0) & (\B~combout\(1) $ (!\A~combout\(1)))))
...
-- Equation(s):
-- \inst9~1_combout\ = (\B~combout\(2) & (\A~combout\(2) & (\B~combout\(3) $ (!\A~combout\(3))))) # (!\B~combout\(2) & (!\A~combout\(2) & (\B~combout\(3) $ (!\A~combout\(3)))))
...
-- Equation(s):
-- \inst9~2_combout\ = (\B~combout\(5) & (\A~combout\(5) & (\A~combout\(4) $ (!\B~combout\(4))))) # (!\B~combout\(5) & (!\A~combout\(5) & (\A~combout\(4) $ (!\B~combout\(4)))))
...
-- Equation(s):
-- \inst9~3_combout\ = (\inst9~0_combout\ & (\inst9~1_combout\ & \inst9~2_combout\))
